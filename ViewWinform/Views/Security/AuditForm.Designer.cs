namespace MVCWinform.Security {
    partial class AuditForm {
        ...
        private void InitializeComponent() {
            ...
            this.Name = "AuditView";
            this.Text = "AuditView";
            //this.OnRecordPositionChanged += new MVCWinform.Common.CommonView.RecordPositionHandler(this.AuditViewOnRecordPositionChanged);
            //this.OnRecordOperationInvoked += new MVCWinform.Common.CommonView.RecordOperationHandler(this.AuditViewOnRecordOperationInvoked);
